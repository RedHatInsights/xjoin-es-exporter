...
COMPONENT_NAME="xjoin-es-exporter"  # name of app-sre "resourceTemplate" in deploy.yaml for this component
IMAGE="quay.io/cloudservices/xjoin-es-exporter"  # image location on quay
...
echo "This pr_check builds container image"
